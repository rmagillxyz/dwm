...
static unsigned int gappih = 00;  /* horiz inner gap between windows */
static unsigned int gappiv = 00;  /* vert inner gap between windows */
...
static const Rule rules[] = {
    ...
    {"VirtualBox", NULL, NULL, 1 << 7, 0, 0, 0, -1},
